...
```
npm install Arrowchain/bitcore-lib-arrow
```

```
bower install Arrowchain/bitcore-lib-arrow
```
...
```sh
git clone https://github.com/Arrowchain/bitcore-lib-arrow
cd bitcore-lib-arrow
npm install
```
